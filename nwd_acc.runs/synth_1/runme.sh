...
HD_PWD='C:/Users/tomas/Desktop/nwd_acc/nwd_acc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nwd_acc_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nwd_acc_design_wrapper.tcl
