...
HD_PWD='C:/Users/tomas/Desktop/nwd_acc/nwd_acc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nwd_acc_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nwd_acc_design_wrapper.tcl -notrace
