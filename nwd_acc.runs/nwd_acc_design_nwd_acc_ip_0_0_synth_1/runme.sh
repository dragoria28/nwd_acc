...
HD_PWD='C:/Users/tomas/Desktop/nwd_acc/nwd_acc.runs/nwd_acc_design_nwd_acc_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nwd_acc_design_nwd_acc_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nwd_acc_design_nwd_acc_ip_0_0.tcl
